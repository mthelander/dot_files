...
(defun color-theme-charcoal-black-custom ()
  "Color theme by Lars Chr. Hausmann, created 2003-03-24. -- customized by mjt"
  (interactive)
  (color-theme-install
   '(color-theme-charcoal-black-custom
     ...
     ((display-time-mail-face . mode-line)
      ...
      (view-highlight-face . highlight)
      (widget-mouse-face . highlight))
     (default ((t (:stipple nil :background "color16" :foreground "Grey" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 87 :width semi-condensed :family "misc-fixed"))))
     (Info-title-1-face ((t (:bold t :weight bold :family "helv" :height 1.728))))
     (Info-title-2-face ((t (:bold t :family "helv" :weight bold :height 1.44))))
     (Info-title-3-face ((t (:bold t :weight bold :family "helv" :height 1.2))))
     (Info-title-4-face ((t (:bold t :family "helv" :weight bold))))
...
(defun color-theme-mjt-purple-custom ()
  "Theme generated by Sweyla: http://sweyla.com/themes/seed/734583/"
  (interactive)
  (color-theme-install
   '(color-theme-mjt-purple-custom
     ((background-color . "#010207")
      (foreground-color . "#FFFFFF")
      (bacpkground-mode . dark)
      (border-color . "#323232")
      (cursor-color . "#FFFFFF")
      (mouse-color . "#323232"))
     ...
     (font-lock-comment-face ((t (:foreground "#A4104F"))))
     (font-lock-constant-face ((t (:foreground "#DB0074"))))
     (font-lock-builtin-face ((t (:foreground "#FF0CB1"))))
     (font-lock-function-name-face ((t (:foreground "#C01BC9"))))
     (font-lock-variable-name-face ((t (:foreground "#A116CE"))))
     (font-lock-keyword-face ((t (:foreground "#DF00A0"))))
     (font-lock-string-face ((t (:foreground "#FF51FF"))))
     (font-lock-doc-string-face ((t (:foreground "#FF51FF"))))
     (font-lock-type-face ((t (:foreground "#4C00E6")))))))

(provide 'color-theme-mjt-purple-custom)

(defun color-theme-mjt-blue-custom ()
  "Theme generated by Sweyla: http://sweyla.com/themes/seed/755080/"
  (interactive)
  (color-theme-install
   '(color-theme-mjt-blue-custom
     ...
     (font-lock-builtin-face ((t (:foreground "#89FF74"))))
     (font-lock-function-name-face ((t (:foreground "#FFFF59"))))
     (font-lock-variable-name-face ((t (:foreground "#7BD2FF"))))
     (font-lock-keyword-face ((t (:foreground "#09FF85"))))
     (font-lock-string-face ((t (:foreground "#00FFFF"))))
     (font-lock-doc-string-face ((t (:foreground "#00FFFF"))))
     (font-lock-type-face ((t (:foreground "#00FFE2"))))
     )))

(provide 'color-theme-mjt-blue-custom)


(defun color-theme-ron ()
  "Port of ron.vim"
  (interactive)
  (let ((*purple*      "#AD7FA8")
        (*light-green* "#08FFAF")
